...
@section('title', 'Criminal Procedure Code Management - Admin Dashboard')
@section('page-title', 'Criminal Procedure Code Management')

@section('content')
<div class="row mb-4">
    <div class="col-md-6">
        <div class="d-flex gap-2">
            <a href="{{ route('admin.criminal-procedure-code.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-lg me-2"></i>Add Section Data
            </a>
        </div>
    </div>
    <div class="col-md-6">
        <form action="{{ route('admin.criminal-procedure-code.index') }}" method="GET" class="d-flex gap-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('admin.criminal-procedure-code.edit', $section) }}" class="btn btn-sm btn-outline-warning">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <a href="{{ route('admin.criminal-procedure-code.amendments.create', $section) }}" class="btn btn-sm btn-outline-info">
                                            <i class="bi bi-plus-circle"></i>
                                        </a>
                                        <form action="{{ route('admin.criminal-procedure-code.destroy', $section) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
