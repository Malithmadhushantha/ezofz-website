...
@section('title', 'Edit Criminal Procedure Code Section - Admin Dashboard')
...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.criminal-procedure-code.index') }}" class="btn btn-outline-secondary btn-sm">
                <i class="bi bi-arrow-left me-1"></i>Back to List
            </a>
        </div>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.criminal-procedure-code.update', $section) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('admin.criminal-procedure-code.index') }}" class="btn btn-secondary">Cancel</a>
