...
@section('title', "Section {$section->section_number} - {$section->name_of_the_section} | Criminal Procedure Code Database")

@section('content')
<div class="container my-4">
    <!-- Back Button -->
    <div class="mb-4">
        <a href="{{ route('criminal-procedure-code.index') }}" class="btn btn-outline-primary">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('criminal-procedure-code.index') }}" class="btn btn-outline-primary btn-sm">
                            <i class="bi bi-arrow-left me-2"></i>Back to All Sections
                        </a>
...
function toggleLike(sectionId) {
    fetch(`/criminal-procedure-code/${sectionId}/like`, {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
        }
...
function shareSection() {
    ...
    if (navigator.share) {
        ...
        navigator.share({
            title: sectionTitle,
            text: `Check out this Criminal Procedure Code section: ${sectionTitle}`,
            url: url
        }).then(() => {
