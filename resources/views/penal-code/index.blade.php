                                ...
                                <div class="col-md-6 col-lg-4 mb-3">
                                    <div class="card h-100 border-primary">
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('penal-code.show', $starredSection) }}" class="btn btn-sm btn-outline-primary">View Section</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="col-md-6 col-lg-4 mb-3">
                                    <div class="card h-100 border-info">
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('penal-code.show', $noteSection) }}" class="btn btn-sm btn-outline-info">View Section</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
