...
@section('title', 'Sri Lanka Police Station Directory - Find Police Divisions and Stations')
@section('description', 'Comprehensive directory of all police stations in Sri Lanka. Search by province, division, or station name to find contact details and locations.')
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p class="text-center mb-4 section-subtitle">
                        Search for any police station to get complete details including division, contact information, and location.
