...
<div class="container py-4">
    ...
    <h2 class="mb-4"><i class="bi bi-shield-lock me-2"></i>Police Documents</h2>
    <ul class="nav nav-tabs mb-4">
        <li class="nav-item">
            <a class="nav-link" href="{{ route('documents.law') }}">Law Documents</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('documents.police') }}">Police Documents</a>
        </li>
    </ul>
    @if($documents->count())
    ...
    @else
        <div class="alert alert-info">
            No police documents available at this time.
        </div>
    @endif
