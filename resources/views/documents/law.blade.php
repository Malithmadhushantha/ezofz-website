...
@section('content')
<div class="law-documents-page min-vh-100">
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
                        <div class="header-info">
                            <h1 class="page-title mb-2">
                                <i class="bi bi-scale me-3"></i>Law Documents
                                @if(isset($subcategoryModel))
                                    <small class="subcategory-title">/ {{ $subcategoryModel->name }}</small>
                                @endif
                            </h1>
                            <p class="page-subtitle mb-0">Browse and download official law documents and legal forms</p>
                        </div>
        ...
        <div class="row mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="col-12">
                <ul class="nav nav-pills document-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('documents.law') }}">
                            <i class="bi bi-scale me-2"></i>Law Documents
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('documents.police') }}">
                    ...
                    <div class="subcategory-filter">
                        ...
                        <div class="subcategory-buttons">
                            ...
                            @foreach($subcategories as $subcategory)
                                <a href="{{ route('documents.law.subcategory', $subcategory->id) }}"
            ...
            <div class="row" data-aos="fade-up">
                <div class="col-12">
                    <div class="empty-state">
                        ...
                        <h4 class="empty-title">No Law Documents Found</h4>
                        <p class="empty-description">
                            No law documents are available at this time. Please check back later or browse our other document categories.
                        </p>
                        <div class="empty-actions">
                            <a href="{{ route('documents.police') }}" class="btn btn-primary">
                                <i class="bi bi-shield-check me-2"></i>Browse Police Documents
                            </a>
...
.file-download.pdf-file:hover {
    background: rgba(239, 68, 68, 0.1);
    border-color: rgba(239, 68, 68, 0.5);
    box-shadow: 0 4px 12px rgba(239, 68, 68, 0.2);
}

.file-download.word-file {
    border-color: rgba(59, 130, 246, 0.3);
}

.file-download.word-file:hover {
...
.file-download.excel-file:hover {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    downloadButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            console.log(`Downloading Law ${fileType} file: ${documentTitle}`);
